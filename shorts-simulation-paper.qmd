...
By deriving @eq-velocity-time, we may obtain @eq-acceleration-time for horizontal acceleration.

$$
  a(t) = \frac{MSS}{TAU} \times e^{-\frac{t}{TAU}}
$$ {#eq-acceleration-time}

By integrating @eq-velocity-time, we get the distance covered in @eq-distance-time.
...
Mike represents the *theoretical model*, in which we assume that the initial force production and the timing initiation are perfectly synchronized. We have already utilized Mike's split times in @tbl-example-split-times.

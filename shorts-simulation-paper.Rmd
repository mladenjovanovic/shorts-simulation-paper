---
title: "Bias in estimated short sprints profiles using timing gates due to the flying start: simulation study and proposed solutions"
preprint: true
date: "`r Sys.Date()`"
author: 
...
Out of `r formatC(not_fitted_df$Total, format="f", big.mark=",", digits=0)` simulations for 0 $m$ flying distance, *estimated FD* model was not been able to be fitted for `r formatC(not_fitted_df$"Not fitted", format="f", big.mark=",", digits=0)` simulations, or `r round(not_fitted_df$"Not fitted (%)", 0)`%. These were disregarded from further analysis. 
...
### Region of practical equivalence (`region of practical equivalence`)
